...
class OccupancyMapping : public rclcpp::Node
{
    ...
    : Node("bof")
    {
        subscription_ = this->create_subscription<nav_msgs::msg::Odometry>("/hagen/odom", 20, std::bind(&OccupancyMapping::odom_callback, this, _1));
        subscription2_ = this->create_subscription<sensor_msgs::msg::LaserScan>("/hagen/scan", rclcpp::SensorDataQoS(), std::bind(&OccupancyMapping::scanCallback, this, _1));
