...
class EKFLocalization():
    ...
    def get_linearized_motion_model(self):
        ...
        # TODO use sympy to define motion model f 
        f = 
        ...
        # TODO get linearized state transition matrix 
        self.F_j = 
        # TODO get linearized control matrix 
        self.V_j = 
        return
    ...
    def get_linearized_measurement_model(self, x, landmark_pos):
        ...
        # TODO define linearized_measurement_model H
        H =
        return Hx, H
